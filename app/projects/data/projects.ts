...
export const projects: ProjectType[] = [
  ...
  {
    id: 3,
    slug: 'x-nest-boilerplate',
    projectName: 'X-Nest-Boilerplate',
    summary:
    ...
    techStack: [
      ...
      {
        tech: 'Frameworks/Libraries',
        values: ['NestJS', 'TypeORM', 'Vitest', 'Biome.js'],
      },
      {
        tech: 'Database',
        values: ['PostgreSQL'],
    ...
    repoLink: 'https://github.com/yourusername/x-nest-boilerplate',
    challenges: [
      {
        challenge: 'Ensuring compatibility and integration of Vitest and Biome.js with NestJS.',
        solution:
          'Implemented configuration adjustments and thorough testing to achieve seamless integration.',
      },
      {
        challenge: 'Addressing performance bottlenecks and bugs in the existing boilerplate.',
        solution:
          'Conducted detailed code reviews, refactored critical sections, and optimized database queries for improved efficiency.',
      },
    ],
    learningOutcome: [
