...
const Footer = () => {
  return (
    <footer className="flex justify-center flex-wrap items-center ">
      <div
        className="hidden md:w-[90%] sm:flex w-full mt-6 lg:mt-20 p-3 lg:pt-8 flex-col flex-wrap 
      ...
      >
        ...
        <Link href="/contact">
          <p className="text-[0.5rem] sm:text-sm text-gray-400 p-1">
            ...
            <span
              className="ml-2 p-1 border bg-gray-700 shadow-sm tracking-wider 
        ...
        <p className="sm:text-sm text-gray-400 p-1">© 2023 Safvan</p>
      </div>
      <div
        className="flex sm:hidden w-full mt-6 p-3 flex-col flex-wrap justify-center 
      ...
      >
        <Link href="/contact">
          <p className="text-[0.5rem] sm:text-sm text-gray-400 p-1">
            ...
            Interested in working together? We should queue up a time to chat.
            <span
              className="ml-1 mt-1 text-[0.5rem] sm:text-sm p-[0.1rem] border bg-gray-700 shadow-sm 
